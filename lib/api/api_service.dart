...
class ApiService {
  ...
  Future<RestResponse> addPost({
    ...
    if (postHashTag != null || postHashTag!.isNotEmpty) {
      request.fields[UrlRes.postHashTag] = postHashTag.isEmpty ? '' : postHashTag;
    }
  ...
  Future<NudityMediaId> checkVideoModerationApiMoreThenOneMinutes({required File? file, required String apiUser, required String apiSecret}) async {
    ...
    log('checkVideoModerationApiMoreThenOneMinutes  : ${nudityStatus.toJson()}');
    return nudityStatus;
  }
