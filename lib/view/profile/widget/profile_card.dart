    ...
    return userData == null
        ...
        : Column(
            children: [
              ...
              InkWell(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      border: Border.all(
                          color: ColorRes.colorTextLight, width: 0.5),
              ...
              SizedBox(height: 5),
              userData?.profileCategoryName == null ||
                      userData!.profileCategoryName!.isEmpty
                  ? SizedBox()
                  : Container(
              ...
              Text(userData?.fullName ?? AppRes.emptyName,
                  maxLines: 1,
                  overflow: TextOverflow.ellipsis,
                  style: TextStyle(
                      fontSize: 20, fontFamily: FontRes.fNSfUiSemiBold)),
              Row(
                  ...
                  VerticalTilesCustom(
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => FollowerScreen(userData)),
                      );
                    },
                ...
                children: [
                  !isMyProfile
                      ? FollowUnFollowButton(
                          data: userData,
                          followClick: onFollowUnFollowClick,
                          isLogin: isLogin,
...
class VerticalTilesCustom extends StatelessWidget {
  ...
  const VerticalTilesCustom(
      {Key? key, required this.onTap, required this.count, required this.title})
      : super(key: key);
