          ...
          child: Scaffold(
            body: Stack(
              children: [
                ...
                SafeArea(
                  child: Column(
                    children: [AudienceTopBar(model: model, user: user), Spacer(), LiveStreamChatList(commentList: model.commentList, pageContext: context), LiveStreamBottomField(model: model)],
                  ),
                )
              ],
            ),
